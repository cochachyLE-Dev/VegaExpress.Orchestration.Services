...
namespace Liiksoft.Data.Orm.Dapper
{
    ...
    {
        internal sealed class Identity<TFirst, TSecond, TThird, TFourth, TFifth, TSixth, TSeventh, TEighth, TNinth, TTenth, TEleventh, TTwelfth, TThirteenth, TFourteenth, TFifteenth, TSixteenth> : Identity
        {
            ...
            static int CountNonTrivial(out int hashCode)
            {
                ...
                _ = Map<TFirst>() && Map<TSecond>() && Map<TThird>()
                    ...
                    && Map<TSeventh>() && Map<TEighth>() && Map<TNinth>()
                    && Map<TTenth>() && Map<TEleventh>() && Map<TTwelfth>()
                    && Map<TThirteenth>() && Map<TFourteenth>() && Map<TFifteenth>()
                    && Map<TSixteenth>();
            ...
            internal override Type GetType(int index) 
            {
                switch (index)
                {
                    ...
                    case 7:
                        return typeof(TEighth);
                    case 8:
                        return typeof(TNinth);
                    case 9:
                        return typeof(TTenth);
                    case 10:
                        return typeof(TEleventh);
                    case 11:
                        return typeof(TTwelfth);
                    case 12:
                        return typeof(TThirteenth);
                    case 13:
                        return typeof(TFourteenth);
                    case 14:
                        return typeof(TFifteenth);
                    case 15:
                        return typeof(TSixteenth);                    
                    default:
        ...
        public class Identity : IEquatable<Identity>
        {
            ...
            internal Identity ForGrid<TFirst, TSecond, TThird, TFourth, TFifth, TSixth, TSeventh, TEighth, TNinth, TTenth, TEleventh, TTwelfth, TThirteenth, TFourteenth, TFifteenth, TSixteenth>(Type primaryType, int gridIndex) =>
                new Identity<TFirst, TSecond, TThird, TFourth, TFifth, TSixth, TSeventh, TEighth, TNinth, TTenth, TEleventh, TTwelfth, TThirteenth, TFourteenth, TFifteenth, TSixteenth>(sql, commandType, connectionString, primaryType, parametersType, gridIndex);
